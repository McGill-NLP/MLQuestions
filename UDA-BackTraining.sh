...
#3. IR model generates embeddings for 50k passages
...
#4. IR model retrieves passages from questions and prepares synthetic data for back-training QG
...
#5. Train QG model on synthetic back-training data
cd ../QG/
python train.py --epochs 5 --train_file outputs/BT.tsv --checkpoint NQ-checkpoint/

#6. Train IR model on synthetic back-training data
cd ../IR/
