...
class BiEncoderTrainer(object):
    ...
    def validate_nll(self) -> float:
        ...
        print('NLL Validation: loss = %f. correct prediction ratio  %d/%d ~  %f', total_loss,
                    total_correct_predictions,
                    total_samples,
                    correct_ratio
                    )
...
def main():
    ...
    parser.add_argument('--save_model_after', type=int, default=0)
    parser.add_argument('--validate_model_after', type=int, default=0)
